...
// Connexion
export async function loginAction({ phone, password }:any) {
  try {
...
export async function getUserByIdAction(id :any) {
  try {
...
export async function updateUserAction(id :any, { firstName, lastName, imageUrl } :any) {
  try {
...
export async function deleteUserAction(id :any) {
  try {
...
export async function getCarByIdAction(id :any) {
  try {
...
export async function updateCarAction(id :any, carData :any) {
  try {
...
export async function deleteCarAction(id :any) {
  try {
...
export async function getOrderByIdAction(id :any) {
  try {
...
export async function updateOrderAction(id :any, orderData :any) {
  try {
...
export async function deleteOrderAction(id :any) {
  try {
