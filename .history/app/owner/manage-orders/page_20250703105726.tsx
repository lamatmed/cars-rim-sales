...
import { dummyMyBookingsData } from "../../../public/assets/assets";
...
export default function ManageOrdersPage() {
  return (
    <main className="min-h-screen bg-gray-50">
      <Navbar />
      <section className="max-w-5xl mx-auto px-4 py-1">
        <div className="mb-6">
          ...
          {dummyMyBookingsData.map((order) => (
            <div key={order._id} className="bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex flex-col gap-2">
                <button className="bg-green-100 hover:bg-green-200 text-green-700 font-bold py-2 px-4 rounded-lg text-sm">Accepter</button>
                <button className="bg-red-100 hover:bg-red-200 text-red-700 font-bold py-2 px-4 rounded-lg text-sm">Refuser</button>
