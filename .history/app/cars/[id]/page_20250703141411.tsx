        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="flex items-center">
              <Image src={assets.users_icon} alt="Passagers" width={20} height={20} className="mr-2" />
              <span className="text-gray-600">{car.seating_capacity} places</span>
            </div>
            <div className="flex items-center">
              <Image src={assets.fuel_icon} alt="Carburant" width={20} height={20} className="mr-2" />
              <span className="text-gray-600">{car.fuel_type}</span>
            </div>
            <div className="flex items-center">
              <Image src={assets.car_icon} alt="Transmission" width={20} height={20} className="mr-2" />
              <span className="text-gray-600">{car.transmission}</span>
            </div>
            <div className="flex items-center">
              <Image src={assets.location_icon} alt="Localisation" width={20} height={20} className="mr-2" />
          ...
          <div className="mt-8 flex justify-between items-center">
            <div className="flex items-center">
              <Image src={assets.star_icon} alt="Évaluation" width={20} height={20} className="mr-1" />
