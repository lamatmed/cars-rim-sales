...
export default function CarsPage() {
  ...
  if (cars.length === 0) return <div className="text-center text-gray-500  if (cars.length === 0) return <div className="text-center text-gray-500 mt-10">Aucune voiture trouvée.</div>;
">Aucune voiture trouvée.</div>;
