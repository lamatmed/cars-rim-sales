  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-violet-50 to-purple-100 flex flex-col">
      ...
      <section className="flex-1 flex flex-col justify-center items-center py-12 px-4">
        ...
        >
          {/* Effets décoratifs */}
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-purple-300 rounded-full opacity-20 blur-3xl"></div>
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-indigo-300 rounded-full opacity-20 blur-3xl"></div>
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-purple-400 to-indigo-600 rounded-full blur-md opacity-30 -z-10"></div>
            </div>
          ...
          <div className="flex mb-6 bg-indigo-50 rounded-xl p-1">
            <button
              onClick={() => setLoginMethod('email')}
              className={`flex-1 py-2.5 rounded-lg transition-all ${
                loginMethod === 'email'
                  ? 'bg-white shadow-md font-medium text-indigo-700'
          ...
          <form className="space-y-5">
            {loginMethod === 'email' ? (
              <div className="relative">
                ...
                <div className="relative">
                  <FiMail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-indigo-400" />
                  <input 
                    type="email" 
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-white text-gray-500 text-sm">ou continuer avec</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="flex items-center justify-center py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
              <Image src={assets.google} alt="Google" width={20} height={20} className="mr-2" />
              <span className="text-gray-700 font-medium">Google</span>
            </button>
            <button className="flex items-center justify-center py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
              <Image src={assets.facebook} alt="Facebook" width={20} height={20} className="mr-2" />
