...
import { FiUser, FiPhone, FiLock, FiEye, FiEyeOff, FiCamera } from "react-icons/fi";
      ...
      <section className="flex-1 flex flex-col justify-center items-center py-12 px-4">
        ...
        >
          ...
          <form className="space-y-5">
            {/* Champ d'upload de photo de profil */}
            <div className="flex justify-center">
              <div className="relative group">
                <div className="w-24 h-24 rounded-full bg-gray-100 border-2 border-dashed border-indigo-200 flex items-center justify-center overflow-hidden">
                  {imageUrl ? (
                    <Image 
                      src={imageUrl} 
                      alt="Profile" 
                    ...
                    <FiCamera className="text-indigo-300 text-2xl" />
                  )}
                </div>
                ...
                <input 
                  ...
                  onChange={(e) => {
                    if (e.target.files?.[0]) {
                      // Ici vous devriez traiter le téléchargement réel
                      // Pour la démo, nous utilisons une URL fictive
