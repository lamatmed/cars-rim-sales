      ...
      <section className="flex-1 flex flex-col justify-center items-center py-18">
        ...
        >
          ...
          >
            ...
            <h1 className="text-2xl font-extrabold text-indigo-700 tracking-tight">Créer un compte</h1>
          </motion.div>
          <form className="space-y-6">
            <div className="flex gap-4">
              <div className="flex-1">
                <label className="block text-indigo-700 font-semibold mb-2">Prénom</label>
                <input type="text" className="w-full px-4 py-3 rounded-lg border border-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-indigo-50/60 text-gray-800" placeholder="Votre prénom" required />
              </div>
              <div className="flex-1">
                <label className="block text-indigo-700 font-semibold mb-2">Nom</label>
                <input type="text" className="w-full px-4 py-3 rounded-lg border border-indigo-200 focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-indigo-50/60 text-gray-800" placeholder="Votre nom" required />
              </div>
            </div>
            <div>
          ...
          <p className="text-center text-indigo-500 text-sm mt-6">
            Déjà un compte ? <Link href="/login" className="text-indigo-700 hover:underline font-semibold">Se connecter</Link>
          </p>
        </motion.div>
      </section>
      <Footer />
