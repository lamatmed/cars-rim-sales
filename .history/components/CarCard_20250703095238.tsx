...
export default function CarCard({ car }: { car: Car }) {
  return (
    <div className="bg-[#23272F] rounded-xl shadow-lg overflow-hidden flex flex-col hover:scale-105 transition-transform cursor-pointer">
      ...
      <div className="p-4 flex flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          <span className="bg-[#00C6AD] text-white px-3 py-1 rounded-lg font-semibold text-lg">{car.price} € /j</span>
        </div>
